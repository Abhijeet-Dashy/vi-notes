    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-vibe-card border border-vibe-border rounded-2xl shadow-2xl w-full max-w-[440px] p-8 md:p-10 transition-transform hover:-translate-y-1 duration-300">
        <div className="text-center mb-8">
          ...
          <p className="text-vibe-muted text-sm border-b border-vibe-border pb-6">Login to your account to continue</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-vibe-muted">
          <p>Don't have an account? <Link to="/register" className="text-vibe-accent hover:text-vibe-accent-hover font-medium transition-colors hover:underline">Register here</Link></p>
        </div>
      </div>
    </div>
  );
